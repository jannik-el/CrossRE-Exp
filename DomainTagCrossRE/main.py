...
# running command
# $python TestRunningFolder/DomainTagCrossRE/main.py --train_path TestRunningFolder/DomainTagCrossRE/crossre_data/ai-train.json --dev_path TestRunningFolder/DomainTagCrossRE/crossre_data/ai-dev.json --test_path TestRunningFolder/DomainTagCrossRE/crossre_data/ai-test.json --exp_path TestRunningFolder/testing4 --seed 42
